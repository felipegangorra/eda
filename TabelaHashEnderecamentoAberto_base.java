 ...
 * Computação @ UFCG
 */
public class TabelaHashEnderecamentoAberto_base {
     ...
     */
    public TabelaHashEnderecamentoAberto_base() {
     ...
     */
    public TabelaHashEnderecamentoAberto_base(int capacidade, double fatorDeCarga) {
